...
- [ ] 完整閱讀Claude最近乾跑診斷、既有handoff文件及每日研究流程，分開可直接沿用與必須修復的項目。
- [ ] 撰寫Claude可直接執行的每日研究、資料、品質閘門、故障降級與發布操作包。
- [ ] 整理Claude必須上傳的檔案、連結與權限，並標記敏感資料不得上傳。
- [ ] 提供先修復B1／B2與授權GitHub寫入後才啟用排程的最終移交次序。
